...
- Completion history with notes, materials, performed-by metadata and optional cost tracking
- Statistics for reliability, runs, effort, a twelve-month forecast and a health trend
- Notifications translated into the Home Assistant instance language
...
- Compact Material 3 status summary instead of large KPI cards
