...
def default_settings() -> dict[str, Any]:
    ...
    return {
        ...
        "workflow": {
            ...
            "default_recurrence_mode": "standard",
            "persistent_default_state": "ready",
...
def normalize_settings(settings: dict[str, Any] | None) -> dict[str, Any]:
    ...
    if workflow.get("default_recurrence_mode") not in {"standard", "persistent"}:
        workflow["default_recurrence_mode"] = "standard"
    if workflow.get("persistent_default_state") not in {"planned", "ready", "in_progress", "blocked"}:
        workflow["persistent_default_state"] = "ready"
