...
class MaintenanceDashboardPanel extends HTMLElement {
  ...
  async _load() {
    ...
    try {
      ...
      if (!this._statisticsYear) this._statisticsYear = Number(this._state?.statistics?.year || new Date().getFullYear());
      if (this._view === "statistics" && this.hass?.callWS) {
