...
const MODULE_KEYS = ["assets", "consumption", "evidence", "inventory", "budget"];
...
const I18N = Object.freeze({
  "de": {
    ...
    "assetNoDevice": "Kein Gerät verknüpft",
    "assets": "Anlagen",
    "assetsEmpty": "Noch keine Anlagen angelegt.",
    "assetSerial": "Seriennummer",
    "assetsHint": "Geräte und Bauteile, an denen Wartungen hängen. Garantien und Verträge werden überwacht.",
    ...
    "contractExpiresAt": "Vertrag läuft bis",
    "contractPartner": "Vertragspartner",
    "contractReference": "Vertragsnummer",
    "contractResponseHours": "Reaktionszeit (Stunden)",
    ...
    "deleteAssetHint": "Zugeordnete Aufgaben bleiben erhalten und verlieren nur die Verknüpfung.",
    "deleted": "Gelöscht",
    ...
    "mobileMore": "Mehr",
    "module_assets": "Anlagen & Geräte",
    "module_assetsHint": "Geräte, Garantien und Wartungsverträge verwalten.",
    ...
    "module_evidence": "Nachweis",
    "module_evidenceHint": "Fotos vorher/nachher und druckbarer Jahresbericht.",
  ...
  "en": {
    ...
    "assetContract": "Maintenance contract",
    ...
    "assetModel": "Model",
    "assetName": "Name",
    "assetNoDevice": "No device linked",
    "assets": "Assets",
    "assetsEmpty": "No assets yet.",
    "assetSerial": "Serial number",
    "assetsHint": "Devices and components that maintenance hangs off. Warranties and contracts are watched.",
    ...
    "contractExpiresAt": "Contract runs until",
    "contractPartner": "Contract partner",
    "contractReference": "Contract reference",
    "contractResponseHours": "Response time (hours)",
    ...
    "deleteAssetHint": "Linked tasks are kept and only lose the link.",
    "deleted": "Deleted",
    ...
    "mobileMore": "More",
    "module_assets": "Assets and devices",
    "module_assetsHint": "Manage devices, warranties and maintenance contracts.",
    "module_budget": "Budget",
    ...
    "module_evidenceHint": "Before/after photos and a printable yearly report.",
...
class MaintenanceDashboardPanel extends HTMLElement {
  ...
  _render() {
    ...
    this.shadowRoot.innerHTML = `${this._styles()}<main class="shell density-${this._html(this._density)}">${this._hero()}${content}${this._dialogHtml()}${this._taskDetailSheetHtml()}${this._qualityDialogHtml()}${this._templateImportDialogHtml()}${this._mobileActionSheetHtml()}${this._shortcutsDialogHtml()}${this._historyDialogHtml()}${this._diagnosticsHtml()}${this._dataDialogHtml()}${this._notificationDialogHtml()}${this._templatePreviewHtml()}${this._completionDialogHtml()}${this._bulkPreviewHtml()}${this._assetDialogHtml()}${this._partDialogHtml()}${this._onboardingDialogHtml()}${this._toastHtml()}</main>`;
    this._bind();
...
Object.assign(MaintenanceDashboardPanel.prototype, {
  ...
  _viewHtml() {
    ...
    if (this._view === "assets") return this._assetsEnabled() ? this._assetsHtml() : this._dashboardHtml();
...
Object.assign(MaintenanceDashboardPanel.prototype, {
  _taskDetailSheetHtml() {
    ...
    const tabs = [
      ...
      ...(this._evidenceEnabled() ? [["photos", "photoGallery", "mdi:image-multiple-outline"]] : []),
    ...
    const body = {
      ...
      notes: notesTab,
      history: historyTab,
      ...(this._evidenceEnabled() ? { photos: this._taskPhotosHtml(task.id) } : {}),
...
Object.assign(MaintenanceDashboardPanel.prototype, {
  ...
  _needsCompletionDialog(task) {
    ...
    const checklist = Array.isArray(task?.checklist) ? task.checklist : [];
    const showChecklist = this._workflowSettings().show_checklists !== false && checklist.length;
    return Boolean(showChecklist || Object.values(requirements).some(Boolean));
  },
...
Object.assign(MaintenanceDashboardPanel.prototype, {
  ...
  _evidenceEnabled() {
    return Boolean(this._state?.settings?.modules?.evidence);
  },
