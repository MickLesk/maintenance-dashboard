...
Object.assign(MaintenanceDashboardPanel.prototype, {
  _bind() {
    ...
    onAll("[data-action='quick-create-template']", "click", () => { this._quickCreateOpen = false; this._view = "templates"; this._render(); });
    ...
    onAll("[data-action='apply-today-focus']", "click", () => { this._applyFilterPayload({ due: "today", sort: "due" }); this._showCompleted = false; this._render(); });
    onAll("[data-action='apply-quality-check']", "click", () => { this._search = "quality:issue"; this._showCompleted = false; this._render(); });
...
Object.assign(MaintenanceDashboardPanel.prototype, {
  _styles() {
    ...
    .toolbar.compact-dashboard-toolbar,.templates-toolbar{position:static;z-index:auto;margin:0 0 26px;padding:0;border:0;border-radius:0;background:transparent;backdrop-filter:none;box-shadow:none;grid-template-columns:minmax(0,1fr) auto;align-items:end;gap:14px;}
    .compact-dashboard-toolbar .dashboard-main{display:grid;grid-template-columns:minmax(280px,1.1fr) minmax(132px,.38fr) minmax(160px,.48fr) 48px minmax(196px,.62fr);gap:12px;align-items:end;min-width:0;}
    ...
    .compact-dashboard-toolbar .completed-toggle{justify-content:center;white-space:nowrap;padding:0 16px;}
    ...
    .dashboard-focus-bar{display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin:-14px 0 20px}
    .dashboard-focus-bar button{display:inline-flex;align-items:center;gap:8px;min-height:38px;padding:0 12px;border:1px solid var(--md-sys-color-outline-variant);border-radius:999px;background:var(--md-sys-color-surface-container-low);color:var(--md-sys-color-on-surface);font-weight:800}
    .dashboard-focus-bar button strong{display:inline-grid;place-items:center;min-width:24px;height:24px;padding:0 7px;border-radius:999px;background:var(--md-sys-color-surface-container-high);color:var(--md-sys-color-primary)}
    ...
    .favorite-button{margin-left:auto;color:var(--md-sys-color-on-surface-variant)}
