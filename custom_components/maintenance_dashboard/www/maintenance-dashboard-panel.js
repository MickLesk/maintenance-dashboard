...
Object.assign(I18N.de, {
  cardsView: "Kachel", compactView: "Liste", tableView: "Tabelle", calendarView: "Kalender", timelineView: "Zeitachse",
  ...
  dashboardLayout: "Dashboard-Ansicht", dashboardWidgets: "Dashboard-Widgets", dashboardSurfaceHint: "Ansicht, Dichte und Filterverhalten.", saveDashboardSettings: "Dashboard-Einstellungen speichern",
...
Object.assign(I18N.en, {
  cardsView: "Grid", compactView: "List", tableView: "Table", calendarView: "Calendar", timelineView: "Timeline",
  ...
  dashboardLayout: "Dashboard view", dashboardWidgets: "Dashboard widgets", dashboardSurfaceHint: "View, density and filter behavior.", saveDashboardSettings: "Save dashboard settings",
...
Object.assign(MaintenanceDashboardPanel.prototype, {
  _hero() {
    return `<section class="hero"><div class="hero-brand compact-brand"><strong>Maintenance Dashboard</strong></div><div class="hero-actions">${this._nav("dashboard", "mdi:view-dashboard", this._t("dashboard"))}${this._nav("templates", "mdi:shape-outline", this._t("templates"))}<button data-action="history-dialog" class="nav icon-nav" title="${this._t("openHistory")}"><ha-icon icon="mdi:history"></ha-icon><span class="sr-only">${this._t("history")}</span></button><button data-view="settings" class="nav icon-nav ${this._view === "settings" ? "active" : ""}" title="${this._t("settings")}"><ha-icon icon="mdi:cog"></ha-icon><span class="sr-only">${this._t("settings")}</span></button></div></section>`;
  },
