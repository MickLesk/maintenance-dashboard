...
Object.assign(MaintenanceDashboardPanel.prototype, {
  _templatesHtml() {
    ...
    return `<section class="page-header"><div><p class="eyebrow">${this._t("brandName")}</p><h1>${this._t("templates")}</h1><p>${this._t("templateSelectHint")}</p></div></section>
      <section class="toolbar expressive templates-toolbar"><div class="toolbar-main templates-main"><input id="search" class="search" placeholder="${this._t("search")}" value="${this._html(this._search)}"><button class="ghost" data-action="select-visible"><ha-icon icon="mdi:checkbox-multiple-marked-outline"></ha-icon>${this._t("selectAllVisible")}</button><button class="ghost" data-action="clear-template-selection"><ha-icon icon="mdi:checkbox-blank-off-outline"></ha-icon>${this._t("deselectAll")}</button><button class="primary big" data-action="add-selected" ${selected.length ? "" : "disabled"}><ha-icon icon="mdi:plus-box-multiple-outline"></ha-icon>${this._t("addSelected")} · ${selected.length}</button></div></section>
  ...
  _settingsHtml() {
    ...
    return `
      ...
      <nav class="settings-nav" aria-label="${this._t("settings")}">
        ...
        <a href="#notification-settings">${this._t("notifications")}</a>
        <a href="#diagnostics-settings">${this._t("diagnostics")}</a>
      </nav>
      ...
      <section class="settings-grid">
        ...
        <article class="panel settings-section" id="diagnostics-settings">
        ...
        <article class="panel settings-section" id="notification-settings">
...
Object.assign(MaintenanceDashboardPanel.prototype, {
  _styles() {
    ...
    /* v1.8.3 Material 3 Expressive UI refresh */
    :host{
