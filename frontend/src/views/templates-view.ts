...
Object.assign(MaintenanceDashboardPanel.prototype, {
  _templatesHtml() {
    ...
    return `<section class="page-header page-header-compact"><div><h1>${this._t("templates")}</h1><p>${this._t("templateSelectHint")}</p></div><div class="page-header-actions"><button class="ghost" data-action="open-template-import"><ha-icon icon="mdi:upload"></ha-icon>${this._t("importTemplates")}</button></div></section>
